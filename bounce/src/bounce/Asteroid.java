...
public class Asteroid extends FreeBody {
	...
	public Asteroid(String t, Vector pos, Vector vel, float r) {
		...
		switch (type) {
			case "S":
				addImageWithBoundingBox(ResourceManager.getImage(Breakout.ASTEROID_S_RSC));
				mass = 3;
				strength = 2;
				break;
			case "M":
				addImageWithBoundingBox(ResourceManager.getImage(Breakout.ASTEROID_M_RSC));
				mass = 6;
				strength = 3;
				break;
			case "C":
				addImageWithBoundingBox(ResourceManager.getImage(Breakout.ASTEROID_C_RSC));
				mass = 4;
				strength = 1;
				break;
		}
