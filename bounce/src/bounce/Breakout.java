...
public class Breakout extends StateBasedGame {
	...
	public void initStatesList(GameContainer container) throws SlickException {
		...
		try {	 
			Font font = Font.createFont(Font.TRUETYPE_FONT, ResourceLoader.getResourceAsStream("bounce/resource/Verdana.ttf"));
			
			title = new TrueTypeFont(font.deriveFont(48f), true);
	...
	public static void main(String[] args) {
		...
		try {
			Breakout g = new Breakout("Breakout");
			app = new AppGameContainer(g);
			
			g.ScreenWidth = app.getScreenWidth() - 50;
